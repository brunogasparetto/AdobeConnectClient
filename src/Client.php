 ...
 * @method SCO scoCreate(ArrayableInterface $sco) Create a SCO
 * @method bool scoUpdate(ArrayableInterface $sco) Update a SCO
 ...
 * @method SCO[] scoContents(int $scoId, ArrayableInterface $filter = null, ArrayableInterface $sorter = null) Get the SCO Contents from a folder or from other SCO
 ...
 * @method Principal principalCreate(ArrayableInterface $principal) Create a Principal.
 * @method bool principalUpdate(ArrayableInterface $principal) Update a Principal.
 * @method bool principalDelete(int $principalId) Remove one principal, either user or group
 * @method Principal[] principalList(int $groupId = 0, ArrayableInterface $filter = null, ArrayableInterface $sorter = null) Provides a complete list of users and groups, including primary groups.
 ...
 * @method bool permissionUpdate(ArrayableInterface $permission) Updates the principal's permissions to access a SCO or the access mode if the acl-id is a Meeting
 * @method Permission[] permissionsInfo(int $aclId, ArrayableInterface $filter, ArrayableInterface $sorter) Get a list of principals who have permissions to act on a SCO, Principal or Account
 ...
 * @method bool aclFieldUpdate(int $aclId, string $fieldId, mixed $value, ArrayableInterface $extraParams = null) Updates the passed in Field for the specified ACL
